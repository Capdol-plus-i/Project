    ...
    def setup_for_data_collection(self):
        ...
        try:
            ...
            for name in self.follower_arms:
                ...
                self.follower_arms[name].write("Operating_Mode", 4)
...
class DualCameraDataCollector:
    ...
    def process_frames(self):
        ...
        # leader arm 위치 읽기
        leader_step_positions = self.robot.get_positions('leader')
        ...
        follower_step_positions = self.robot.get_positions('follower')
